        ...
        onWillPop: () async {
          ...
          await showCupertinoDialog(
              ...
              builder: (context) => CupertinoAlertDialog(
                    title: Text(
                        'Profile information is required to use Atly features.'),
                    actions: <Widget>[
                      CupertinoButton(
                        child: Text('Close'),
                        onPressed: () {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              profileCubit.saveUserProfile(
                                  userProfileModel: UserProfileModel(
                                      ...
                                      lastName:
                                          toBeginningOfSentenceCase(lastName),
                                      contactNumber: contactNumber,
                                      bday: bday,
                                      country:
                                          toBeginningOfSentenceCase(country),
                                      city: toBeginningOfSentenceCase(city)));
                            }
                          },
